...
function getData() {
  ph1.innerHTML =
    '<img src="../../img/products/wtop1.jpg" alt="" />'
    ph2.innerHTML =
    '<img src="../../img/products/wtop2.jpg" alt="" />'
    ph3.innerHTML =
    '<img src="../../img/products/wtop3.jpg" alt="" />'
    ph4.innerHTML =
    '<img src="../../img/products/wtop4.jpg" alt="" />'
    ph5.innerHTML =
    '<img src="../../img/products/wtop5.jpg" alt="" />'
    ph6.innerHTML =
    '<img src="../../img/products/wtop6.jpg" alt="" />'
    ph7.innerHTML =
    '<img src="../../img/products/wtop7.jpg" alt="" />'
    ph8.innerHTML =
    '<img src="../../img/products/wtop8.jpg" alt="" />'
    ph9.innerHTML =
    '<img src="../../img/products/wtop9.jpg" alt="" />'
    ph10.innerHTML =
    '<img src="../../img/products/wtop10.jpg" alt="" />'
    ph11.innerHTML =
    '<img src="../../img/products/wtop11.jpg" alt="" />'
    ph12.innerHTML =
    '<img src="../../img/products/wtop12.jpg" alt="" />'
