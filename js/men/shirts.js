...
function getData() {
  ph1.innerHTML =
    '<img src="../../img/products/msh1.jpg" alt="" />'
    ph2.innerHTML =
    '<img src="../../img/products/msh2.jpg" alt="" />'
    ph3.innerHTML =
    '<img src="../../img/products/msh3.jpg" alt="" />'
    ph4.innerHTML =
    '<img src="../../img/products/msh4.jpg" alt="" />'
    ph5.innerHTML =
    '<img src="../../img/products/msh5.jpg" alt="" />'
    ph6.innerHTML =
    '<img src="../../img/products/msh6.jpg" alt="" />'
    ph7.innerHTML =
    '<img src="../../img/products/msh7.jpg" alt="" />'
    ph8.innerHTML =
    '<img src="../../img/products/msh8.jpg" alt="" />'
    ph9.innerHTML =
    '<img src="../../img/products/msh9.jpg" alt="" />'
    ph10.innerHTML =
    '<img src="../../img/products/msh10.jpg" alt="" />'
    ph11.innerHTML =
    '<img src="../../img/products/msh11.jpg" alt="" />'
    ph12.innerHTML =
    '<img src="../../img/products/msh12.jpg" alt="" />'
